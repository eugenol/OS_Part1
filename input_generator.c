...
int main(int argc, char **argv)
{
    ...
    gsl_rng * r; //Create instance of RAndom number generator
    ...
    r = gsl_rng_alloc(gsl_rng_mt19937); // (gsl_rng_taus); //Create instance of Random number generator
